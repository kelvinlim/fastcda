...
During the initial phase, we use jpype to call methods in the Tetrad java program from Carnegie Mellon University (https://github.com/cmu-phil/tetrad).  This will also facilitate comparison between algorithms. The default Tetrad version being used in 7.6.8.  This corresponds to causal_cmd 7.6.8.  Version 7.6.3 can also be used but
has known problems with the FCI algorithm which have been
fixed in 7.6.8. 
...
To use Tetrad, you will need a Java JDK 21 or higher version. We recommend JDK 21, which is the latest Long-Term Support (LTS) release of the Java SE Platform. It can be downloaded from here: https://www.oracle.com/java/technologies/downloads/#java21
